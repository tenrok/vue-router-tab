...
/* harmony default export */ var contextmenu = ({
  ...
  methods: {
    // 显示页签右键菜单
    showContextmenu: function showContextmenu(id, index, e, parentPath) {
      var _this = this;
...
// 引入目录下语言配置
var lang_context = __webpack_require__("b13e"); // 语言配置


/* harmony default export */ var config_lang = (lang_context.keys().reduce(function (map, path) {
  var _$exec = /\.\/(.*).js/g.exec(path),
      _$exec2 = _slicedToArray(_$exec, 2),
      key = _$exec2[1];

  map[key] = lang_context(path).default;
  return map;
}, {}));
...
/* harmony default export */ var operate = ({
  methods: {
    ...
    open: function open(path) {
      ...
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var isReplace, refresh, isInheritable, items, curId, tarId, isSameTab;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                isInheritable = _arguments.length > 3 && _arguments[3] !== undefined ? _arguments[3] : false;
                items = _this.items;
              ...
              case 12:
                _this.useInheritance && isInheritable && !isReplace ? items.find(function (item) {
                  return item.id === tarId || item.to === tarId;
                }).parentPath = curId : NaN;
                _context.next = 17;
                break;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 13:
                // 如果关闭当前页签，则打开后一个页签
                if (!to || !items.find(function (item) {
                  return item.id === to || item.to === to;
                }) || activeTabId !== id) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.t0 = regeneratorRuntime.keys(cache);
...
/* harmony default export */ var RouterAlivevue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread2(_objectSpread2({}, mapGetters('routeMatch', ['key', 'meta', 'nest', 'alive', 'reusable', 'basePath', 'alivePath'])), {}, {
    // 监听子页面钩子
...
/* harmony default export */ var TabItem = ({
  ...
  computed: _objectSpread2(_objectSpread2({}, mapGetters('data', ['id', 'to', 'icon', 'tabClass', 'target', 'href', 'parentPath'])), {}, {
    // class
  ...
  methods: {
    ...
    // 关闭当前页签
    close: function close() {
      this.$tabs.closeTab(this.id, this.parentPath);
    },
    // 拖拽
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"905c0c38-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./lib/components/ContextmenuItem.vue?vue&type=template&id=d5d7cf74&
var ContextmenuItemvue_type_template_id_d5d7cf74_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.visible)?_c('a',{staticClass:"router-tab__contextmenu-item",class:_vm.menuClass,attrs:{"data-action":_vm.id,"disabled":!_vm.enable,"title":_vm.tips},on:{"click":function($event){_vm.enable && _vm.data.handler(_vm.context)}}},[(_vm.icon)?_c('i',{staticClass:"router-tab__contextmenu-icon",class:_vm.icon}):_vm._e(),_vm._v(" "+_vm._s(_vm.title)+" ")]):_vm._e()}
var ContextmenuItemvue_type_template_id_d5d7cf74_staticRenderFns = []


// CONCATENATED MODULE: ./lib/components/ContextmenuItem.vue?vue&type=template&id=d5d7cf74&
...
var ContextmenuItem_component = normalizeComponent(
  ...
  ContextmenuItemvue_type_template_id_d5d7cf74_render,
  ContextmenuItemvue_type_template_id_d5d7cf74_staticRenderFns,
  false,
  null,
  null,
  null
...
var menuMap = {
  ...
  close: {
    ...
    handler: function handler(_ref4) {
      var data = _ref4.data,
          $tabs = _ref4.$tabs;
      $tabs.closeTab(data.id, data.parentPath);
    }
  },
  // 关闭左侧
  closeLefts: {
    ...
    menuList: function menuList() {
      return this.menu.map(function (item) {
        if (typeof item === 'string') {
          ...
          return origin ? _objectSpread2(_objectSpread2({}, origin), item) : item;
        }
...
var RouterTab = {
  ...
  methods: {
    ...
    getRouteTab: function getRouteTab(_ref2) {
      ...
      var tab = _objectSpread2({}, meta); // 支持根据路由函数返回的页签属性
